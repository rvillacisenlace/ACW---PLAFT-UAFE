...
with sync_playwright() as p:
    ...
    cliente_empresa = Cliente(identificacion="1890010705001", tipo_persona=TipoPersona.JURIDICA, razon_social="(se obtiene del SRI)")

    resultado = resolver_representante_legal(page, scraper_sri, cliente_empresa)
