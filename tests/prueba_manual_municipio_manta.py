...
URL_MUNICIPIO_MANTA = "https://portalciudadano.manta.gob.ec/consulta"
...
with sync_playwright() as p:
    ...
    scraper = ScraperMunicipioManta(context=context, url_base=URL_MUNICIPIO_MANTA)
    cliente = Cliente(identificacion="1301009831", tipo_persona=TipoPersona.NATURAL, nombres_completos="CEDEÑO GUADAMUD SONIA MALENIA")
